...
class TestCompany(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.parsed_csv_data = DictReader(csv_data.splitlines()).__next__() # Parse the CSV data into a dictionary
    ...
    def test_compare_same_companies(self):
        ...
        for key in self.company_data:
            self.assertEqual(comparison[key], {"Current": self.company_data[key], "New": self.company_data[key], "Match": True})
    ...
    def test_compare_different_companies(self):
        ...
        self.assertEqual(comparison["debt_millions"], {"Current": 300, "New": 500, "Match": False})
        self.assertEqual(comparison["equity_millions"], {"Current": 700, "New": 900, "Match": False})
